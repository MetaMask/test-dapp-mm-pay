import{a8 as ve,a9 as fe,aa as ge,ab as be,F as g,S as re,U as l,_ as v,a0 as P,a1 as f,a2 as a,g as K,$ as ce,a7 as le,b as m,m as Y,a4 as ye,ac as S,p as ie,O as E,j as q,A as oe,R as T,f as H,T as xe,ad as Ce,c as ke,a as Se}from"./ThemeUtil-BioSEB-j.js";import{c as u,n as w,r as d,o as F,U as We}from"./index-ClUBzK0e.js";import"./index-C0uQlY1H.js";const p=fe({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),Re={state:p,subscribe(s){return be(p,()=>s(p))},subscribeKey(s,e){return ge(p,s,e)},showTooltip({message:s,triggerRect:e,variant:t}){p.open=!0,p.message=s,p.triggerRect=e,p.variant=t},hide(){p.open=!1,p.message="",p.triggerRect={width:0,height:0,top:0,left:0}}},O=ve(Re),de={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){g.shake();return}if(await re.isSIWXCloseDisabled()){g.shake();return}g.close()}},$e=v`
  :host {
    display: block;
